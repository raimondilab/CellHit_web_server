...
def Clustergram(
        ...
        line_width=0.5,
        paper_bg_color="rgba(255,255,255,255)",
        plot_bg_color="rgba(255,255,255,255)",
        height=500,
        width=500,
        zmin=-3,
        zmax=3,
...
- figure(computed_traces=None): Return a figure object compatible with plotly.graph_objects.
    ...
    - computed_traces (dict; optional): The dendrogram traces from another
        ...
        for i in range(len(col_dendro_traces)):
            ...
            cdt["line"] = dict(width=self._line_width[1], color="#000000")
        ...
        for i in range(len(row_dendro_traces)):
            ...
            rdt["line"] = dict(width=self._line_width[0], color="#000000")
        ...
        if heatmap is None:
            ...
            # Reorder the text dataframe
            if len(self._text) > 0:
                self._text = self._text.loc[self._row_labels, self._column_labels]
